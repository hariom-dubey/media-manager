...
URL_INVALID = "Provided URL is invalid"
INVALID_TYPE = "Provided type in not allowed"
...
ALPHABETS_ONLY = 'Special Characters or Number Not Allowed'
INVALID_DOB = 'DOB cant be Future dates and todays date'
INVALID_MOBILE_NUMBER = 'Mobile Number is not Valid'
SPECIAL_CHARS_NOT_ALLOWED = 'Special Characters not allowed '
INVALID_DATE_FORMAT = 'Date Format not Valid'

INTEGER_ONLY = 'Should contain only numbers'
EMPTY_STRING_VALIDATION = 'Should not contain only spaces'

INVALID_LOAN_NO = 'Invalid loan number'